...
INSERT INTO public.paises (name) VALUES
  ('Chile');
...
CREATE TABLE public.regiones (
  ...
  FOREIGN KEY (id_pais) REFERENCES public.paises (id)
);

INSERT INTO public.regiones (name, id_pais) VALUES
...
CREATE TABLE public.ciudades (
  ...
  FOREIGN KEY (id_region) REFERENCES public.regiones (id),
  FOREIGN KEY (id_pais) REFERENCES public.paises (id)
);


INSERT INTO public.ciudades (nombre, id_region, id_pais) VALUES
  ('Arica',1,1),
	('Camarones',1,1),
	('Putre',1,1),
	('General Lagos',1,1),
